  ...
  return (
    <main className="mx-auto max-w-6xl px-5 py-10 sm:px-8 sm:py-14">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Publicar evento</h1>
        <p className="mt-3 leading-7 text-slate-600">
          A busca consulta a Ticketmaster pelo backend. Ao publicar, os dados essenciais são copiados
          para o banco da plataforma.
        </p>
      </div>
      ...
      {Boolean(catalogQuery.data?.length) && (
        <section className="mt-8" aria-labelledby="catalog-results">
          <h2 id="catalog-results" className="text-lg font-semibold text-slate-950">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="mt-2 font-semibold leading-6 text-slate-950">{event.title}</h3>
